...
class IOToken {
    ...
    toMIO() {
        return new mIOToken(Math.floor(this.value * constants_js_1.MIO_PER_IO));
    }
    toString() {
        return `${this.value}`;
    }
}
exports.IOToken = IOToken;
class mIOToken extends PositiveFiniteInteger {
    constructor(value) {
        super(value);
    }
    multiply(multiplier) {
    ...
    toIO() {
        return new IOToken(this.valueOf() / constants_js_1.MIO_PER_IO);
    }
}
exports.mIOToken = mIOToken;
