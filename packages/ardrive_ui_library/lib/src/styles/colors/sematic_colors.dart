...
class ArDriveColors {
  ArDriveColors({
    ...
    this.themeBgSurface = themeBgSurface ?? const Color(0xff121212);
    this.themeGbMuted = themeGbMuted ?? const Color(0xff2C2C2C);
    this.themeBgSubtle = themeBgSubtle ?? const Color(0xff1C1C1C);
