...
import 'turbo_upload_service_base.dart';

class TurboUploadServiceChunkImpl implements TurboUploadService<Response> {
  TurboUploadServiceChunkImpl({
  ...
  Future<Response> postStream({
    ...
    logger.i('Uploading ${dataItem.id} using Turbo chunked upload');
    ...
    final maxUploadsInParallel = MiB(200).size ~/ uploadChunkSizeInBytes;
    ...
    try {
      logger.i('Finalising upload ${dataItem.id}}');
