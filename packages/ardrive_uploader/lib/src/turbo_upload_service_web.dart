...
import 'package:ardrive_uploader/src/utils/get_headers_for_turbo_streamed_upload.dart';
...
class TurboStreamedServiceImpl implements TurboUploadService {
  @override
  ...
  Future<dynamic> post({
    ...
    final uploadHeaders = await getHeadersForTurboStreamedUpload(
      wallet: wallet,
