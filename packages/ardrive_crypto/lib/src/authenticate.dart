...
//         if (authStreamSize > const MiB(500).size)
//           throw Exception('Stream oversized for DataItem');
...
//         if (dataItem.id != entityTxId)
//           throw Exception('DataItem txId does not match Entity txId');
//         if (!await dataItem.verify())
//           throw Exception('DataItem signature is invalid');

//         // Verified owner
//         return await ownerToAddress(dataItem.owner);
//       } catch (e, s) {
//         debugPrintStack(
//             stackTrace: s, label: 'Error authenticating DataItem: $e');
//         return null;
//       }
//     } else {
//       try {
//         final transaction = (await _arweaveService
//             .getTransaction<TransactionStream>(entityTxId))!;

//         // Ensure that the data_root matches
//         await transaction.processDataStream(authStream, authStreamSize);

//         if (transaction.id != entityTxId)
//           throw Exception('Transaction txId does not match Entity txId');
//         if (!await transaction.verify())
//           throw Exception('Transaction signature is invalid');

//         // Verified owner
//         return await ownerToAddress(transaction.owner!);
//       } catch (e, s) {
//         debugPrintStack(
//             stackTrace: s, label: 'Error authenticating Transaction: $e');
//         return null;
//       }
//     }
//   }
