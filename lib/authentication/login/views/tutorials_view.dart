...
class TutorialsViewState extends State<TutorialsView> {
  ...
  List<_TutorialPage> get _list => [
        _TutorialPage(
          ...
          videoUrl:
              'https://turbo-gateway.com/KynB0c5IBqk66gO2E6W9lqD92sfxZXIuiWT08cmwWzc',
        ),
        _TutorialPage(
          nextButtonText: appLocalizationsOf(context).next,
          nextButtonAction: () {
          ...
          videoUrl:
              'https://turbo-gateway.com/IDxtPlhnBBdXSOSeIwSjFlywc18ZZ2p-QMxtaPT3pZs',
        ),
        _TutorialPage(
          nextButtonText:
          ...
          videoUrl:
              'https://turbo-gateway.com/vhrQJSssEMi2UWx8W6BDijZxT82u2qD_BamI_1NmgRw',
        ),
      ];
