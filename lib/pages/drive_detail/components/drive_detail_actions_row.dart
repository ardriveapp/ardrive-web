    ...
    return BlocBuilder<DriveDetailCubit, DriveDetailState>(
      builder: (context, state) {
        if (state is DriveDetailLoadSuccess) {
          ...
          final fsActions =
              multiSelectEnabled && state.maybeSelectedItem() != null
                  ? [
                      IconButton(
                  ...
                  : <Widget>[
                      if (isViewingSubfolderWithNothingSelected) ...[
                        IconButton(
                          ...
                          onPressed: () {
                            // TODO: revisit this
                            // showRenameModal(context,
                            //     driveId: state.currentDrive.id,
                            //     folderId: state.folderInView.folder.id,
                            //     initialName: state.folderInView.folder.name);
                          },
                            ...
                            onPressed: () {
                              if (maybeSelectedItem is SelectedFolder &&
                                ...
                                promptToRenameModal(
                                  ...
                                  initialName: maybeSelectedItem.item.name,
                                );
                              } else {
                                promptToRenameModal(
                                  context,
