    ...
    return Theme(
      data: theme.copyWith(
        ...
        textTheme: theme.textTheme.apply(
          bodyColor: kOnDarkMediumEmphasis,
          displayColor: kOnDarkMediumEmphasis,
        ),
        iconTheme: theme.iconTheme.copyWith(color: kOnDarkMediumEmphasis),
      ),
    ...
    return Theme(
      data: theme.copyWith(
        textTheme: theme.textTheme
            .apply(bodyColor: kOnBackground, displayColor: kOnBackground),
      ),
      child: Align(
