(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("js-base64")) : typeof define === "function" && define.amd ? define(["exports", "js-base64"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.EmlParseJs = {}, global.Base64));
})(this, function(exports, jsBase64) {
  "use strict";
  var encoding$1 = { exports: {} };
  var encodingIndexes$1 = { exports: {} };
  var encodingIndexes = encodingIndexes$1.exports;
  var hasRequiredEncodingIndexes;
  function requireEncodingIndexes() {
    if (hasRequiredEncodingIndexes) return encodingIndexes$1.exports;
    ...
    return encodingIndexes$1.exports;
  }
  ...
  function requireEncoding() {
    ...
    (function(module2) {
      (function(global) {
        if (module2.exports && !global["encoding-indexes"]) {
          global["encoding-indexes"] = requireEncodingIndexes()["encoding-indexes"];
        }
        ...
        TextDecoder.prototype.decode = function decode2(input, options) {
          var bytes;
  ...
  var textEncoding;
  var hasRequiredTextEncoding;
  function requireTextEncoding() {
    if (hasRequiredTextEncoding) return textEncoding;
    hasRequiredTextEncoding = 1;
    var encoding2 = requireEncoding();
    textEncoding = {
  ...
  var textEncodingExports = requireTextEncoding();
  const encode = (str, fromCharset = "utf-8") => new textEncodingExports.TextEncoder(fromCharset).encode(str);
  const arr2str = (arr) => {
  ...
  function decode(buf, fromCharset = "utf-8") {
    ...
    for (const { charset, fatal } of charsets) {
      try {
        return new textEncodingExports.TextDecoder(charset, { fatal }).decode(buf);
      } catch (e) {
      }
    }
    return arr2str(buf);
  }
  const convert = (data, fromCharset) => typeof data === "string" ? encode(data) : encode(decode(data, fromCharset));
  ...
  const GB2312UTF8 = {
    ...
    GB2312ToUTF8: function(s1) {
      ...
      for (let i2 = 1; i2 < sa.length; i2++) {
        if (sa[i2].substring(0, 1) == "u") {
          retV2 += this.Hex2Utf8(this.Str2Hex(sa[i2].substring(1, 5)));
          if (sa[i2].length) {
    ...
    UTF8ToGB2312: function(str1) {
      ...
      while (i2 != -1) {
        if (i2 < 3) {
          substr = substr + str1.substr(0, i2 - 1);
          str1 = str1.substr(i2 + 1, str1.length - i2);
          a = str1.substr(0, 2);
          str1 = str1.substr(2, str1.length - 2);
          if ((parseInt("0x" + a) & 128) === 0) {
            substr = substr + String.fromCharCode(parseInt("0x" + a));
          } else if ((parseInt("0x" + a) & 224) === 192) {
            b = str1.substr(1, 2);
            str1 = str1.substr(3, str1.length - 3);
            let widechar = (parseInt("0x" + a) & 31) << 6;
            widechar = widechar | parseInt("0x" + b) & 63;
            ...
            c2 = str1.substr(1, 2);
            str1 = str1.substr(3, str1.length - 3);
            let widechar = (parseInt("0x" + a) & 15) << 12;
            widechar = widechar | (parseInt("0x" + b) & 63) << 6;
            widechar = widechar | parseInt("0x" + c2) & 63;
            substr = substr + String.fromCharCode(widechar);
          }
        } else {
          substr = substr + str1.substring(0, i2);
  ...
  function getEmailAddress(rawStr) {
    ...
    const list = parseList.map((v) => ({ name: v.name, email: v.address }));
    if (list.length === 0) {
      return null;
    }
    if (list.length === 1) {
  ...
  function unquotePrintable(value, charset, qEncoding = false) {
  ...
  function read(eml, options, callback) {
    ...
    function _append(headers, content, result2) {
      ...
      } else if (encoding2 === "quoted-printable") {
        content = unquotePrintable(content, charset);
      } else if (encoding2 && charset !== "utf8" && encoding2.search(/binary|8bit/) === 0) {
      ...
      if (!contentDisposition && contentType && contentType.indexOf("text/html") >= 0) {
        ...
        let htmlContent = content.replace(/&quot;/g, '"').replace(/\r\n/g, "\n");
        try {
          if (encoding2 === "base64") {
            const compact = htmlContent.replace(/\s+/g, "");
            if (/^[A-Za-z0-9+/=]+$/.test(compact) && compact.length % 4 === 0) {
              htmlContent = jsBase64.Base64.decode(compact);
            }
          } else {
            const compact = htmlContent.replace(/\s+/g, "");
            ...
            if (base64Like) {
              try {
                const decodedProbe = jsBase64.Base64.decode(compact);
    ...
    if (typeof eml === "string") {
      const parseResult = parse(eml, options);
